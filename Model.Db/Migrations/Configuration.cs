    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AlfredContext>
    {
        ...
        protected override void Seed(AlfredContext context)
        {
            ...
            context.Users.AddOrUpdate(
                p => p.Username,
                new User() { Username = "Guigui", Password = "1000:fb4+tVr04V579XOz7k+7pIzf5B0tUC61:Y/vgDsSL4bpRLAdcVHjHR8SrsL8vCSzM" },
                new User() { Username = "Vince", Password = "1000:tVWAx67KUT+MDwq0XgFWhIPQb3Y3Ax0R:REXI+HGxF0oC85YNzPWZv2M4lDgbsAEy" },
                new User() { Username = "Chloé", Password = "1000:g8fVqlnM2npPPz9ymq1i5YFfe1Lo1syW:Bi9kyt9Aj/r1fEVXpoqKiS8bCu6opHo5" }
            );
