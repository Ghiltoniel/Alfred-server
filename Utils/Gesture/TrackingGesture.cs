...
namespace AlfredInterface
{
    public class TrackingGesture
    {
        ...
        private void FillAllLigthPoints()
        {
            ...
            pointsOrig.Add("Led", new SkeletonPoint() { X = (float)1.5, Y = (float)1, Z = (float)3.75 });
            pointsOrig.Add("Salon", new SkeletonPoint() { X = (float)0.42, Y = (float)0.75, Z = (float)1.84 });
            pointsOrig.Add("Feu rouge", new SkeletonPoint() { X = (float)-0.5, Y = 0, Z = (float)0 });
            pointsOrig.Add("Entrée", new SkeletonPoint() { X = (float)-2, Y = (float)2, Z = (float)0.1 });
            pointsOrig.Add("Cuisine", new SkeletonPoint() { X = (float)-1.90, Y = (float)2, Z = (float)3.2 });
            pointsOrig.Add("Tele", new SkeletonPoint() { X = (float)0, Y = 0, Z = (float)0 });
